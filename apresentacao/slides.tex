...
\usepackage{hyperref,xspace,graphicx,microtype,minted,multicol,mflogo,enumerate,mathtools}
...
% Demonstrar os conceitos usando o arquivo figuras.tex.
\begin{frame}
  \frametitle{\filename{figuras.tex}}
  \Huge
  Estudar \filename{figuras.tex}
\end{frame}
...
\begin{frame}
  \frametitle{\filename{figuras.tex}}
  \Huge
  Resolver \filename{figuras-exercicio.tex}
\end{frame}
